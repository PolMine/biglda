...
[![Travis-CI Build Status](https://api.travis-ci.org/PolMine/biglda.svg?branch=master)](https://travis-ci.org/PolMine/biglda)
...
The *ParallelTopicModel* class from the Machine Learning for Language Toolkit
...
The mallet Java package is not shipped with the "biglda" package. It needs to be
installed explicitly using the `mallet_install()` function. If mallet is not yet
available, a warning will be issued upon loading biglda to install mallet.
