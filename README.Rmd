...
100 iterations for a `k` of 100 topics. In "real life", you would have more 
...
report[[n_cores_max + 2]] <- data.frame(
  tool = "stm",
...
So topic modelling with Mallet is fast and even more so with several cores. So
